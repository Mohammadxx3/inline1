...
local json = (loadfile "/home/flash2/inline/JSON.lua")()
 ...
 if redis:get(hash) then
    ...
    return false
		...
		local keyboard = {}
          ...
          local t = '▪️لیست مدیران گروه: \n\n'
          for k,v in pairs(list) do
          t = t..k.." - *"..v.."*\n" 
          end
          t = t..'\n`▪️برای مشاهده کاربر از دستور زیر استفاده کنید`\n*/whois* `[آیدی کاربر]`'
          if #list == 0 then
          t = '▪️مدیریت برای این گروه ثبت نشده است.'
          end
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
		...
		local keyboard = {}
          ...
          local t = '▪️لیست مالکین گروه: \n\n'
          for k,v in pairs(list) do
          t = t..k.." - *"..v.."*\n" 
          end
          t = t..'\n`▪️برای مشاهده کاربر از دستور زیر استفاده کنید`\n*/whois* `[آیدی کاربر]`'
          if #list == 0 then
          t = '`▪️لیست مالکان گروه خالی میباشد!`'
          end
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
		...
		local keyboard = {}
          ...
          if not rules then
          rules = '`▪️قوانین برای گروه تنظیم نشده است.`'
          end
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
		...
		local keyboard = {}
          ...
          local t = '▪️لیست افراد مسدود شده از گروه: \n\n'
          for k,v in pairs(list) do
          t = t..k.." - *"..v.."*\n" 
          end
          t = t..'\n`▪️برای مشاهده کاربر از دستور زیر استفاده کنید`\n*/whois* `[آیدی کاربر]`'
          if #list == 0 then
          t = '▪️لیست افراد مسدود شده از گروه خالی میباشد.'
          end
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
		...
		local keyboard = {}
          ...
          local t = '▪️لیست کاربران حالت سکوت \n\n'
          for k,v in pairs(list) do
          t = t..k.." - *"..v.."*\n" 
          end
          t = t..'\n`>برای مشاهده کاربر از دستور زیر استفاده کنید`\n*/whois* `[آیدی کاربر]`'
          if #list == 0 then
          t = '▪️لیست کاربران حالت سکوت خالی میباشد!'
          end
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
